...
const accessoryAffixes = {
    ring: [
        { name: '+(54–74) 最大生命', weight: 1 },
        { name: '+(87–117) 最大护盾', weight: 1 },
        { name: '+(5–10)% 火焰抗性', weight: 1 },
        { name: '+(5–10)% 冰冷抗性', weight: 1 },
        { name: '+(5–10)% 闪电抗性', weight: 1 },
        { name: '+(5–10)% 腐蚀抗性', weight: 1 },
        { name: '+(15–20) 力量', weight: 1 },
        { name: '+(15–20) 敏捷', weight: 1 },
        { name: '+(15–20) 智慧', weight: 1 },
        { name: '+(6–8)% 攻击和施法速度', weight: 1 },
        { name: '+(11–15)% 移动速度', weight: 1 },
        { name: '使用轰炸技能时， +(50–66)% 几率 +1 轰炸技能总波次', weight: 1 },
        { name: '+(15–20)% 战意效果', weight: 1 },
        ...
        { name: '造成伤害时，触发 20 级冰寒之触诅咒，冷却时间为 0.2 秒', weight: 1 },
        { name: '附加 (18–20)% 物理伤害的火焰伤害', weight: 1 },
        { name: '附加 (18–20)% 物理伤害的冰冷伤害', weight: 1 },
        { name: '附加 (18–20)% 物理伤害的闪电伤害', weight: 1 },
        { name: '附加 (18–20)% 物理伤害的腐蚀伤害', weight: 1 }
    ],
    necklace: [
        { name: '+(54–74) 最大生命', weight: 1 },
        { name: '+(87–117) 最大护盾', weight: 1 },
        ...
        { name: '+(5–10)% 闪电抗性', weight: 1 },
        { name: '+(5–10)% 腐蚀抗性', weight: 1 },
        { name: '+(3–4)% 元素抗性', weight: 1 },
        { name: '+(15–20) 力量', weight: 1 },
        { name: '+(15–20) 敏捷', weight: 1 },
        { name: '+(15–20) 智慧', weight: 1 },
        { name: '+(20–24)% 伤害 (20–24)% 召唤物伤害', weight: 1 },
        { name: '+(11–15)% 移动速度', weight: 1 },
        { name: '每拥有 1 层任意祝福， +(2–3)% 伤害', weight: 1 },
        { name: '每 27 点属性， +1% 伤害', weight: 1 },
        { name: '附加 10 异常基础伤害', weight: 1 },
...
const weaponAffixes = {
    // 单手武器词缀 (权重30/11/1)
    claw: [
        { name: '攻击附加 (10–15) - (14–19) 点物理伤害', weight: 1 },
        { name: '攻击附加 (9–14) - (15–20) 点火焰伤害', weight: 1 },
        { name: '攻击附加 (10–15) - (14–19) 点冰冷伤害', weight: 1 },
        { name: '攻击附加 (1–2) - (28–32) 点闪电伤害', weight: 1 },
        { name: '攻击附加 (11–16) - (13–18) 点腐蚀伤害', weight: 1 },
        { name: '+(20–24)% 物理伤害', weight: 1 },
        { name: '+(20–24)% 元素伤害', weight: 1 },
        { name: '+(20–24)% 腐蚀伤害', weight: 1 },
        { name: '+(20–24)% 近战伤害', weight: 1 },
        { name: '+(6–8)% 攻击速度', weight: 1 },
        { name: '+1 幻影数量', weight: 1 },
        { name: '额外 +(6–8)% 攻击伤害', weight: 1 },
        { name: '+(6–8)% 元素和腐蚀抗性穿透', weight: 1 },
        { name: '+(5–7)% 护甲减伤穿透', weight: 1 },
        { name: '+1 坚韧祝福层数上限', weight: 1 },
        { name: '+1 灵动祝福层数上限', weight: 1 },
        { name: '+1 聚能祝福层数上限', weight: 1 }
    ],
    ...
    pistol: [
        ...
        { name: '+(20–24)% 元素伤害', weight: 1 },
        { name: '+(20–24)% 腐蚀伤害', weight: 1 },
        { name: '+(20–24)% 远程伤害', weight: 1 },
        { name: '+(6–8)% 攻击速度', weight: 1 },
        { name: '+1 投射物数量', weight: 1 },
        { name: '+1 抛射投射物分裂数量', weight: 1 },
        { name: '+(6–8)% 元素和腐蚀抗性穿透', weight: 1 },
        { name: '+(5–7)% 护甲减伤穿透', weight: 1 },
        { name: '+1 坚韧祝福层数上限', weight: 1 },
        { name: '+1 灵动祝福层数上限', weight: 1 },
        { name: '+1 聚能祝福层数上限', weight: 1 },
        { name: '+(24–32)% 该装备物理伤害', weight: 1 },
        { name: '该装备附加 (32–34) - (40–42) 点物理伤害', weight: 1 },
    ...
    one_hand_sword: [
        ...
        { name: '+(20–24)% 近战伤害', weight: 1 },
        { name: '+(6–8)% 攻击速度', weight: 1 },
        { name: '+(26–32)% 连续攻击几率', weight: 1 },
        { name: '连续攻击伤害递增 (10–16)%', weight: 1 },
        { name: '+(6–8)% 元素和腐蚀抗性穿透', weight: 1 },
        { name: '+(5–7)% 护甲减伤穿透', weight: 1 },
        { name: '+1 坚韧祝福层数上限', weight: 1 },
        { name: '+1 灵动祝福层数上限', weight: 1 },
    ...
    one_hand_hammer: [
        ...
        { name: '+(20–24)% 近战伤害', weight: 1 },
        { name: '+(6–8)% 攻击速度', weight: 1 },
        { name: '消耗破击蓄能时，该次技能额外 +(12–16)% 伤害', weight: 1 },
        { name: '造成伤害时，淘汰生命值低于 (5–7)% 的敌人', weight: 1 },
        { name: '+(6–8)% 元素和腐蚀抗性穿透', weight: 1 },
        { name: '+(5–7)% 护甲减伤穿透', weight: 1 },
        { name: '+1 坚韧祝福层数上限', weight: 1 },
        { name: '+1 灵动祝福层数上限', weight: 1 },
    ...
    one_hand_axe: [
        ...
        { name: '+(20–24)% 近战伤害', weight: 1 },
        { name: '+(6–8)% 攻击速度', weight: 1 },
        { name: '对创伤状态下的敌人，额外 +(6–8)% 伤害', weight: 1 },
        { name: '额外 +(6–9)% 斩击伤害', weight: 1 },
        { name: '+(6–8)% 元素和腐蚀抗性穿透', weight: 1 },
        { name: '+(5–7)% 护甲减伤穿透', weight: 1 },
        { name: '+1 坚韧祝福层数上限', weight: 1 },
        { name: '+1 灵动祝福层数上限', weight: 1 },
    ...
    staff: [
        { name: '法术附加 (10–15) - (14–19) 点物理伤害', weight: 1 },
        { name: '法术附加 (9–14) - (15–20) 点火焰伤害', weight: 1 },
        { name: '法术附加 (10–15) - (14–19) 点冰冷伤害', weight: 1 },
        { name: '法术附加 (1–2) - (28–32) 点闪电伤害', weight: 1 },
        { name: '法术附加 (11–16) - (13–18) 点腐蚀伤害', weight: 1 },
        { name: '+(20–24)% 物理伤害', weight: 1 },
        { name: '+(20–24)% 元素伤害', weight: 1 },
        { name: '+(20–24)% 腐蚀伤害', weight: 1 },
        { name: '+(20–24)% 法术伤害', weight: 1 },
        { name: '+(6–8)% 施法速度', weight: 1 },
        { name: '+1 投射物数量', weight: 1 },
        { name: '+1 抛射投射物分裂数量', weight: 1 },
        { name: '+(6–8)% 元素和腐蚀抗性穿透', weight: 1 },
        { name: '+(5–7)% 护甲减伤穿透', weight: 1 },
    ...
    two_hand_sword: [
        ...
        { name: '+(20–24)% 近战伤害', weight: 1 },
        { name: '+(6–8)% 攻击速度', weight: 1 },
        { name: '+(30–32)% 连续攻击几率', weight: 1 },
        { name: '连续攻击伤害递增 (14–16)%', weight: 1 },
        { name: '+(6–8)% 元素和腐蚀抗性穿透', weight: 1 },
        { name: '+(5–7)% 护甲减伤穿透', weight: 1 },
        { name: '+1 坚韧祝福层数上限', weight: 1 },
        { name: '+1 灵动祝福层数上限', weight: 1 },
    ...
    bow: [
        { name: '攻击附加 (10–13) - (14–19) 点物理伤害', weight: 1 },
        { name: '攻击附加 (9–14) - (15–20) 点火焰伤害', weight: 1 },
        { name: '攻击附加 (10–15) - (14–19) 点冰冷伤害', weight: 1 },
        { name: '攻击附加 (1–2) - (28–32) 点闪电伤害', weight: 1 },
        { name: '攻击附加 (11–16) - (13–18) 点腐蚀伤害', weight: 1 },
